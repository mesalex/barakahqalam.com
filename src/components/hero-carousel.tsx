...
export default function HeroCarousel() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-br from-amber-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <div className="relative md:hidden max-w-6xl mx-auto py-4 sm:py-6">
        <div className="relative" style={{ minHeight: '440px' }}>
          {slides.map((slide, index) => (
            ...
            >
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden shadow-2xl bg-gradient-to-br from-amber-100 to-amber-200 dark:from-gray-700 dark:to-gray-800 group-hover:shadow-amber-500/30 group-hover:scale-[1.02] transition-all duration-300">
                  <img
                    src={slide.image}
                    alt={slide.title}
